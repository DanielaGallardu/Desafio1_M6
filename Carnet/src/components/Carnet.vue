<script>
import bandera from '../assets/img/chile_bandera.png';
import foto from '../assets/img/foto_elon.jpg';
export default {
  name:'Carnet',
  data() {
    return {
  ...
  <div class="carnet">
    <aside>
      <div>
        ...
        <img width="40" :src="banderaUrl" alt="Bandera" />
      </div>

      <img :src="fotoUrl" alt="Foto de Titular" />
      <p>RUN {{ run }}</p>
    </aside>
